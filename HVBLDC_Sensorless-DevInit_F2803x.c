...
// Refer to the datasheet for your particular device. 
   ...
   //------------------------------------------------
   SysCtrlRegs.PCLKCR0.bit.ECANAENCLK=1;//0;   // eCAN-A
   //------------------------------------------------
   ...
   SysCtrlRegs.PCLKCR0.bit.HRPWMENCLK = 1;//0;    // HRPWM
   //------------------------------------------------
   SysCtrlRegs.PCLKCR0.bit.I2CAENCLK = 1;   // I2C
   //------------------------------------------------
   SysCtrlRegs.PCLKCR0.bit.LINAENCLK = 1;//0;   // LIN-A
   //------------------------------------------------
   SysCtrlRegs.PCLKCR3.bit.CLA1ENCLK = 1;//0;   // CLA1
   //------------------------------------------------
   SysCtrlRegs.PCLKCR0.bit.SCIAENCLK = 1;  	// SCI-A
   //------------------------------------------------
   SysCtrlRegs.PCLKCR0.bit.SPIAENCLK = 1;//0;	// SPI-A
   SysCtrlRegs.PCLKCR0.bit.SPIBENCLK = 1;//0;     // SPI-B
   //------------------------------------------------
...
void PieVectTableInit(void)
{
	int16 i;
   	...
   	EALLOW;
   	for(i=0; i < 125; i++) //for(i=0; i < 115; i++)
    *Dest++ = &ISR_ILLEGAL;
   	EDIS;
